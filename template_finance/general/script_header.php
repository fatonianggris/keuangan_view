<head>
    ...
    <link href="<?php echo base_url(); ?>assets/finance/dist/assets/css/pages/fonts/dropify.css" rel="stylesheet"
        type="text/css" />
    <link href="<?php echo base_url(); ?>assets/finance/dist/assets/plugins/custom/datatables/datatables.bundle.css"
        rel="stylesheet" type="text/css" />
    <!-- Popup CSS -->
    <link
        href="<?php echo base_url(); ?>assets/finance/dist/assets/plugins/custom/magnific-popup/dist/magnific-popup.css"
        rel="stylesheet">

    <!--end::Page Vendors Styles-->
    <!--begin::Global Theme Styles(used by all pages)-->
    <link href="<?php echo base_url(); ?>assets/finance/dist/assets/plugins/global/plugins.bundle.css" rel="stylesheet"
        type="text/css" />
    <link href="<?php echo base_url(); ?>assets/finance/dist/assets/plugins/custom/prismjs/prismjs.bundle.css"
        rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url(); ?>assets/finance/dist/assets/css/style.bundle.css" rel="stylesheet"
        type="text/css" />
    <!--end::Global Theme Styles-->
    <!--begin::Layout Themes(used by all pages)-->
    <link href="<?php echo base_url(); ?>assets/finance/dist/assets/css/themes/layout/header/base/light.css"
        rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url(); ?>assets/finance/dist/assets/css/themes/layout/header/menu/light.css"
        rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url(); ?>assets/finance/dist/assets/css/themes/layout/brand/dark.css" rel="stylesheet"
        type="text/css" />
    <link href="<?php echo base_url(); ?>assets/finance/dist/assets/css/themes/layout/aside/dark.css" rel="stylesheet"
        type="text/css" />
    <!--end::Layout Themes-->
    <link rel="shortcut icon" href="<?php echo base_url(); ?>assets/finance/dist/assets/media/logos/favicon.ico" />
    <link rel="stylesheet"
        href="<?php echo base_url(); ?>assets/finance/dist/assets/plugins/custom/owlcarousel/dist/assets/owl.carousel.min.css">
    <link rel="stylesheet"
        href="<?php echo base_url(); ?>assets/finance/dist/assets/plugins/custom/owlcarousel/dist/assets/owl.theme.default.css">
    <style>
    .blink_print {
...
<script src="<?php echo base_url(); ?>assets/finance/dist/assets/plugins/custom/datatables/datatables.bundle.js">
</script>
<script src="https://gyrocode.github.io/jquery-datatables-checkboxes/1.2.11/js/dataTables.checkboxes.min.js"></script>
<script>
var HOST_URL = "<?php echo base_url(); ?>";
var CAPTCA_KEY = "<?php echo $this->config->item('google_site_key'); ?>";
var PRINT_KEY = "<?php echo $this->config->item('recta_key'); ?>";
var PRINT_PORT = "<?php echo $this->config->item('recta_port'); ?>";
</script>
<script src="<?php echo base_url(); ?>assets/finance/dist/assets/js/YouShallPass.js"></script>
<script src="<?php echo base_url(); ?>assets/finance/dist/assets/js/recta.js"></script>
<script src="<?php echo base_url(); ?>assets/finance/dist/assets/js/print.js"></script>
